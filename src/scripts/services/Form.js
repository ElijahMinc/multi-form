export class Form {
   ...
   static isInvalidFormat(file, validFormats){
      const formats = validFormats || ['application/x-dosexec',
   ...
   validateFields(inputs){
      ...
      inputs.forEach((input) => {
          ...
          if(input.type === 'radio'){
              ...
              const isSomeoneChecked = Array.from(wrapperContainer.querySelectorAll('input'))
         ...
         switch(input.type){
             ...
             case 'hidden': 
                 ...
                 vscomCustomSelect.addEventListener('change', () => {
                  ...
                  console.log('changed after prefetch data', vscomCustomSelect.classList.contains('_after-prefetch'))
