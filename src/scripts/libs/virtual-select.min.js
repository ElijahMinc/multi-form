        ...
        (i = [
                ...
                (this.$ele.innerHTML = r),
                  ...
                  this.hasDropboxWrapper
                    ? ((this.$allWrappers = [
                      ...
                      h.addClass(this.$dropboxContainer, 'pop-comp-wrapper'))
            ...
            value: function (e) {
              ...
              if (i) {
                ...
                return (
                  ...
                  (s.innerHTML = o),
                  i.appendChild(s),
                  h.addClass(s, 'vscomp-dropbox-wrapper '.concat(t)),
                  ''
                );
              }
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                (a &&
                  (e = new RegExp(
                    '('.concat(s.regexEscape(this.searchValue), ')'),
                    'gi'
                  )),
              ...
              o.forEach(function (o) {
                ...
                o.classNames && (f += ' '.concat(o.classNames)),
                  ...
                  (s = c ? l(o) : o.label),
                  o.description &&
                    (m = '<div class="vscomp-option-description" '
                      .concat(y, '>')
          ...
          },
          {
            ...
            value: function (e) {
              ...
              t &&
                this.isOpened() &&
                (h.hasClass(t, 'disabled') || h.hasClass(t, 'group-title')
          ...
          },
          {
            ...
            value: function () {
              ...
              (!this.allowNewOption ||
                ...
                h.toggleClass(this.$allWrappers, 'has-no-search-results', i),
                h.toggleClass(this.$allWrappers, 'has-no-options', t),
                this.setOptionAttr(),
          ...
          },
          {
            ...
            value: function () {
              ...
              var m = function e(s) {
                var m;
                'object' !== f(s) && (v((m = {}), o, s), v(m, n, s), (s = m));
                var O = h(u(s[o])),
                  S = s.options,
                  x = !!S,
                  w = {
                ...
                if (
                  ...
                  s.isGroupOption &&
                    ((w.isGroupOption = !0), (w.groupIndex = s.groupIndex)),
                  l && (w.description = h(u(s[r]))),
                  s.customData && (w.customData = s.customData),
                  t.push(w),
                  (d += 1),
                  x)
                ) {
            ...
            value: function () {
              ...
              s
                ? (this.setVisibleOptionsCount(),
                  ...
                  this.setValueText())
                : this.updatePosition(),
                h.removeClass(this.$allWrappers, 'server-searching');
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              ...
              0 === a ? (y = this.placeholder) : o || (y = r.join(', ')),
                ...
                e &&
                  (h.setData(s, 'tooltipEllipsisOnly', 0 === a),
            ...
            value: function (e) {
              ...
              if (e !== this.searchValueOriginal || i) {
                ...
                (this.searchValue = o),
                  ...
                  h.toggleClass(this.$allWrappers, 'has-search-value', e),
              ...
              e
                ...
                : ((t = this.optionsHeight),
                  this.keepAlwaysOpen &&
                    ...
                    h.setStyle(this.$noSearchResults, 'height', t))),
                h.setStyle(this.$optionsContainer, 'max-height', t),
          ...
          },
          {
            ...
            value: function () {
              if (!this.showAsPopup) {
                ...
                h.setStyle(this.$dropboxContainer, 'max-width', e);
              }
            },
          },
          {
            ...
            value: function () {
              var e = this.maxWidth,
                t = {};
              e && (t['max-width'] = e), h.setStyles(this.$ele, t);
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              (this.isSilentOpen = e),
                e
                  ? h.setStyle(this.$dropboxContainer, 'display', 'inline-flex')
            ...
            value: function () {
              ...
              (this.isSilentOpen = !1),
                e ||
                  ...
                  this.showAsPopup
                    ? (h.addClass(this.$body, 'vscomp-popup-active'),
            ...
            value: function (e) {
              (this.isSilentClose = e),
                this.keepAlwaysOpen
                  ? this.removeOptionFocus()
                  : (e
                      ? h.setStyle(this.$dropboxContainer, 'display', '')
                      : (h.dispatchEvent(this.$ele, 'beforeClose'),
                        h.setAria(this.$wrapper, 'expanded', !1),
                        h.setAria(this.$wrapper, 'activedescendant', '')),
                    this.dropboxPopover && !e
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.isSilentClose = !1),
                ...
                !e &&
                  this.isPopupActive &&
                  (h.removeClass(this.$body, 'vscomp-popup-active'),
            ...
            value: function () {
              ...
              if (o) e = o;
                ...
                (e = this.$dropboxContainer.querySelector(
                  ...
                  (h.hasClass(e, 'disabled') || h.hasClass(e, 'group-title')) &&
              ...
              e &&
                ...
                this.toggleFocusedProp(h.getData(e, 'index'), !0),
            ...
            value: function (e) {
              ...
              if (t) {
                var i,
                  ...
                  p = s.height,
                  c = t.offsetTop,
                  d = h.getData(this.$options, 'top', 'number');
                n > l ? (i = c + d) : r < u && (i = c - a + p + d),
              ...
              if (this.multiple && !this.disableSelectAll) {
                var t =
                    'boolean' == typeof isSelected
                      ? e
                      : !h.hasClass(this.$toggleAllCheckbox, 'checked'),
                  i = [],
            ...
            value: function (e) {
              if (this.multiple) {
                ...
                'boolean' == typeof e || (e = this.isAllOptionsSelected()),
                  ...
                  h.toggleClass(this.$toggleAllCheckbox, 'checked', e || t),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.forEach(function (e) {
                ...
                this.afterValueSet(),
                e && h.removeClass(this.$allWrappers, 'has-error'),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return (
                ...
                r || !u || h || (h = -1 !== u.toLowerCase().indexOf(i)),
                (t.isVisible = h),
                o || (o = l === i || a === i),
          ...
          },
          {
            key: 'serverSearch',
            value: function () {
              h.removeClass(this.$allWrappers, 'has-no-search-results'),
                h.addClass(this.$allWrappers, 'server-searching'),
            ...
            value: function () {
              ...
              return (
                this.required &&
                  ...
                  (e = !0),
                h.toggleClass(this.$allWrappers, 'has-error', e),
                !e
              );
            },
          },
          ...
          },
          {
            ...
            value: function (e, t) {
              e &&
                ...
                t && h.setAria(this.$wrapper, 'activedescendant', e.id));
            },
          },
        ]) && O(t.prototype, i),
        o && O(t, o),
          ...
          (t = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  (i.setStyle(this.$popperEle, 'transform', L),
